...
//}
//
//void v2_chunk_hasher_mixin::process_piece_hash(file_storage& storage, std::size_t leaf_index,
//        std::size_t file_index, const sha256_hash& piece_hash)
//{
//    auto& tree = merkle_trees_[file_index];
//    tree.set_leaf(leaf_index, piece_hash);
//}
//
